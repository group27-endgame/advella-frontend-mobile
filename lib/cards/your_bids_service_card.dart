...
class YourBidsServiceCard extends StatefulWidget {

  var services = <Service>[];
  var categories = <ServiceCategory>[];
  //var categoryTitles = <String>[];

  YourBidsServiceCard(this.services, this.categories);

  @override
  State<YourBidsServiceCard> createState() => _YourBidsServiceCardState();
}

class _YourBidsServiceCardState extends State<YourBidsServiceCard> {
