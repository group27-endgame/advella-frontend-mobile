...
class _BrowseScreenState extends State<BrowseScreen>
  ...
  List<Task> tasks = [
    Task(title: 'Need to fix my bike',
    ...
    Task(title: 'IKEA closet assembly',
    ...
    Task(title: 'Mow lawn and trim hedges',
        location: 'Vejen, 6600',
        price: '310 DKK',
        duration: '9 hour',
        dueDate: '21/09/2021',
  ...
  var trendingServices = <OldService>[
    OldService(title: 'Hiking instructor',
        ...
        numberOfBids: 5),
    OldService(title: 'Glacier expert needed',
              ...
              child: Container(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      child: Align(
                        ...
                        child: TabBar(
                          ...
                          indicator: CircleTabIndicator(color: Colors
                              .blueAccent,
                              radius: 4),
                          tabs: [
                            Tab(text: 'Trending'),
                    ...
                    Container(
                        child: FutureBuilder(
                            future: viewmodel.getAllServices(),
                            builder: (BuildContext context,
                                AsyncSnapshot snapshot) {

                              if(viewmodel.services.length == 0)
                                {
                                  return Container(
                                    child: Center(
                                ...
                                return Container(
                                  ...
                                  child: TabBarView(
                                    ...
                                    children: [
                                      BrowseServices(
                                          trendingServices, products, categories),
                                      ServicesCard(viewmodel.services),
